...
//Create variable named quoteString that holds "Failure is simply the opportunity to begin again this time more intelligently."
...
let charThree = secondQuote.charAt(3)
alert(`The character at location 3 is: ${charThree}`)
...
let removeString = findString.splice(1,1)
alert(removeString)
